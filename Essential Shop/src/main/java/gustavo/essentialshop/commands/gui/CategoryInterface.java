package gustavo.essentialshop.commands.gui;
...
import gustavo.essentialshop.Shop.ShopProduct;
...
public class CategoryInterface {
    ...
    public CategoryInterface(Player player, EssentialShop plugin, ShopInterface shopInterface, String categoryName) {
        this.player = player;
    ...
    public void openBlocos() {
        ChestGui shop = new ChestGui(5, "Shop: " + category);
    ...
    private static ItemStack getItem(ShopProduct product) {
        ...
        lore.add("");
        lore.add("  §fPreço: §2$§f" + product.getPrice());
        lore.add("");
